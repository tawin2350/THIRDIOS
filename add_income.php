...
// ดึงหมวดหมู่รายรับ
$sql_categories = "SELECT * FROM categories WHERE category_type = 'income' ORDER BY category_name";
...
<head>
    ...
    <title>เพิ่มรายรับ - THIRDIOS</title>
        ...
        <div class="dashboard-container">
            <div class="form-page-card">
                <div class="form-page-header">
                    <i class="fas fa-plus-circle"></i>
                    <h2>เพิ่มรายรับ</h2>
                    <p>บันทึกรายรับของคุณ</p>
                </div>
                
                <form id="addIncomeForm" class="form-page">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-submit">
                            <i class="fas fa-save"></i> บันทึกรายรับ
                        </button>
    ...
    <script>
        ...
        document.getElementById('addIncomeForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                // แสดง Result Modal
                if (result.success) {
                    showResultModal(true, result.message || 'บันทึกรายรับเรียบร้อยแล้ว');
                } else {
                    showResultModal(false, result.message || 'ไม่สามารถบันทึกรายรับได้');
                }
            } catch (error) {
                hideLoadingModal();
                submitBtn.disabled = false;
